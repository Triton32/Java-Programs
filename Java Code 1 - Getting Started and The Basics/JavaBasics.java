...
//This is how you start any java program. It is always the name of the java file.
public class JavaBasics{
	
//This is how a method is declared in java. var1 and var2 are the variables containing the numbers you inputted in the main method.
    public int ifStatement(int var1, int var2){
        String word = "ERROR";						//Store "ERROR" inside the String variable word
		int answer1 = 0;							//Initialize answer variable with 0
	...
	public int whileLoop(int var1, int var2){
		...
		return answer2;
	}												//Note: var1 is not used in this method
...
//This function is going to be used to call and excecute different your functions/methods, print answeres and declare some variables.	
	public static void main(String[] args){
		JavaBasics Object = new JavaBasics(); 		//Make an variable to called Object to call and excecute different functions/methods. 
