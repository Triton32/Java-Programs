...
public class JavaCodeThree{
	...
	public static void main(String[] args){
		...
		int[] oneToTwelve = Obj.storeOneToTwelve(tempArray);		//Store 1-12 into variable OneToTwelve
		
		int[] answer = Obj.correctAnswer(oneToTwelve);				//Store the correct answeres into answer
		
		int countCorrect = Obj.testIfCorrect(answer, oneToTwelve);	//Get the amount of correct answeres
