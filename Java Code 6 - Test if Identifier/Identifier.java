...
JAVA - Test if Identifier - CODE SIX
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
*/
/*
...
public class Identifier{										
	...
	public static void main(String[] args){
		...
		if (Object.testIfJavaIdentifier(userInput)){							//Can be true or false, this is the value of the return variable temp in method testIfJavaIdentifier
